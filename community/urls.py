...
urlpatterns = [
    ...
    path('start_signup', views.community_unauthorized,
         name="community_unauthorized"),
    path('recipe_posts/', views.recipe_list, name='recipes'),
    path('recipe_posts/<slug:slug>/', views.recipe_detail,
         name='recipe_detail'),
    path('workout_posts/', views.workout_list, name='workouts'),
    path('workout_posts/<slug:slug>/',
    ...
    path('edit_recipe/<slug:slug>/', views.edit_recipe_post,
         name="edit_recipe"),
    path('edit_workout/<slug:slug>/',
         views.edit_workout_post, name="edit_workout"),
    path('edit_other_post/<slug:slug>/',
         views.edit_other_post, name="edit_other_post"),
    ...
    path('search_results/', views.community_search_result,
         name="search_results"),
]
